...
- 글자가 길어 화면을 넘치면 **한 번만** 왼쪽으로 흘러 끝까지 보여 준 뒤 멈추고, 그 뒤로는
  손으로 좌우로 밀어 다시 볼 수 있습니다. 짧으면 가운데 정지합니다.
...
<img src="cap/cap2.jpg" width="280" alt="오늘 편성표">

- 방송 정보 줄을 누르면 **그 채널의 오늘 하루 편성표**가 아래에서 올라옵니다.
- 하루치 편성을 공개하는 **KBS · MBC · SBS** 채널에서만 열립니다.
- 방송사가 주는 원본을 그대로 뿌리지 않고 다듬습니다. KBS는 두 시간짜리 프로그램을 30분 단위로
  끊어 주는데(같은 제목이 네 줄) 하나로 잇고, 그 사이에 낀 1~2분짜리 캠페인은 걸러 냅니다.
  자정을 넘긴 심야 편성(`24:00~05:00`)도 새벽 시간대에 "방송 중"으로 잡히도록 처리합니다.

### 취침 타이머 (30분 간격 예약 종료)

<img src="cap/cap3.jpg" width="280" alt="취침 타이머">
...
<img src="cap/cap4.jpg" width="280" alt="업데이트 안내">
